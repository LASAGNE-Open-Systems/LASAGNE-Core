...
extern "C" CLS##_Export ACE_Stream<ACE_SYNCH, ACE_System_Time_Policy> * \
...
void ACE_MAKE_SVC_CONFIG_GOBBLER_NAME(ACE_VERSIONED_NAMESPACE_NAME,SERVICE_CLASS) (void *p) { \
  ACE_Stream<ACE_SYNCH, ACE_System_Time_Policy> * _p = \
    static_cast< ACE_Stream<ACE_SYNCH, ACE_System_Time_Policy> *> (p); \
  ACE_ASSERT (_p != 0); \
  delete _p; } \
extern "C" CLS##_Export ACE_Stream<ACE_SYNCH, ACE_System_Time_Policy> *\
...
extern "C" CLS##_Export ACE_Module<ACE_SYNCH, ACE_System_Time_Policy> * \
ACE_MAKE_SVC_CONFIG_FACTORY_NAME(ACE_VERSIONED_NAMESPACE_NAME,SERVICE_CLASS) (ACE_Service_Object_Exterminator *);

#if 0
#define DAF_MODULE_DEFINE(CLS,SERVICE_CLASS) \
void ACE_MAKE_SVC_CONFIG_GOBBLER_NAME(ACE_VERSIONED_NAMESPACE_NAME,SERVICE_CLASS) (void *p) { \
  ACE_Module<ACE_SYNCH, ACE_System_Time_Policy> * _p = \
    static_cast< ACE_Module<ACE_SYNCH, ACE_System_Time_Policy> *> (p); \
  ACE_ASSERT (_p != 0); \
  delete _p; } \
extern "C" CLS##_Export ACE_Module<ACE_SYNCH, ACE_System_Time_Policy> *\
ACE_MAKE_SVC_CONFIG_FACTORY_NAME(ACE_VERSIONED_NAMESPACE_NAME,SERVICE_CLASS) (ACE_Service_Object_Exterminator *gobbler) \
