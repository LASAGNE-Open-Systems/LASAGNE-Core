...
***************************************************************/
#ifndef TAF_IDL_VISITOR_H
#define TAF_IDL_VISITOR_H
...
// This class is a combination of TAO/TAO_IDL/be_visitor_scope
class TAF_IDL_BE_Export Visitor : public ast_visitor
{
protected:
    Visitor(AST_Decl* scope);
public:
